...
export default function LoginEstudiante() {
  ...
  const handleEntrar = async (e) => {
    ...
    try {
      ...
      if (snap.empty) {
        setError(
          "Código de aula incorrecto. Pídele el código a tu maestra."
        );
        setCargando(false);
        return;
      }
  ...
  return (
    <div className="estudiante-container">
      ...
      <div className="estudiante-card">
        ...
        <div className="estudiante-logo">
          🧒
        </div>

        <h1 className="estudiante-title">
          ¡Hola!
        </h1>
